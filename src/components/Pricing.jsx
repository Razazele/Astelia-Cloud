        ...
        <div name='pricing' className='w-full text-white my-24'>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <h3 className='text-5xl font-bold text-white py-8'>El precio justo para tu Investigacion</h3>
                    <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus beatae accusamus eius quisquam cumque nemo molestiae esse magnam? Quos, laudantium?</p>
                </div>
